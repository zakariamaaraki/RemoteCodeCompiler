...
```
The value of the env variable **DELETE_DOCKER_IMAGE** is by default equals to true, and that means that each docker image is deleted after the execution of the container. 
