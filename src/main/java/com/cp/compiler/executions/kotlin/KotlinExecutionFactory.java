...
/**
 * The type Kotlin execution factory.
 */
public class KotlinExecutionFactory implements AbstractExecutionFactory {
    ...
    /**
     * Instantiates a new Kotlin execution factory.
     *
     * @param executionCounter        the execution counter for monitoring
     * @param entryPointFileGenerator the entry point file generator
     */
    public KotlinExecutionFactory(Counter executionCounter, EntrypointFileGenerator entryPointFileGenerator) {
    ...
    public Execution createExecution(MultipartFile sourceCode,
                                     ...
                                     int timeLimit,
                                     int memoryLimit) {
        return new KotlinExecution(sourceCode, inputFile, expectedOutputFile, timeLimit, memoryLimit, executionCounter, entryPointFileGenerator);
    }
}
